...
__all__ = [
    ...
    'DISPID_SRRSaveToMemory', 'SPEI_VISEME', 'SVSFVoiceMask',
    'SSFMCreate', 'SRSInactiveWithPurge', 'ISpeechLexicon',
    'DISPID_SGRAddResource', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechPhraseRule', 'SITooLoud',
    'DISPID_SRGSetTextSelection', 'DISPID_SPAStartElementInResult',
    'DISPID_SWFESamplesPerSec', 'STSF_CommonAppData',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpeechDiscardType',
    'DISPID_SABIBufferSize', 'DISPID_SpeechPhraseAlternates',
    'SPSEMANTICERRORINFO', 'SAFT22kHz8BitMono', 'DISPID_SPCPhoneToId',
    ...
    'SP_VISEME_12', 'DISPID_SRCRecognizer', 'DISPID_SLWsCount',
    'SpeechAudioState', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRCEPropertyNumberChange', 'SPTEXTSELECTIONINFO',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVPriority',
    'SpeechRetainedAudioOptions', 'SRERequestUI',
    'SpeechTokenShellFolder', 'DISPID_SPERetainedStreamOffset',
    'SAFT16kHz16BitMono', '_RemotableHandle', 'SPPS_RESERVED2',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechAddRemoveWord', 'SPBO_PAUSE', 'DISPID_SABufferInfo',
    'SpeechCategoryPhoneConverters', 'SAFT22kHz16BitStereo',
    'DISPID_SDKSetStringValue', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpObjectWithToken', 'eLEXTYPE_PRIVATE3', 'SPSHT_EMAIL',
    'SPWAVEFORMATTYPE', 'DISPID_SPEAudioTimeOffset',
    'Speech_StreamPos_Asap', 'DISPID_SOTs_NewEnum', 'SPSUnknown',
    'DISPID_SBSRead', 'DISPID_SWFEExtraData', 'DISPID_SLGetWords',
    'SREPropertyStringChange', 'DISPID_SVSLastBookmark', 'ISpPhrase',
    '_SPAUDIOSTATE', 'DISPID_SRGDictationUnload',
    'SRTExtendableParse', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechLexiconProns',
    '_ISpeechVoiceEvents', 'SAFTCCITT_uLaw_44kHzMono',
    'SPINTERFERENCE_LATENCY_WARNING', 'SGSEnabled',
    'DISPID_SGRSTs_NewEnum', 'SpeechCategoryAudioIn',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPPNumberOfElements',
    'eLEXTYPE_PRIVATE4', 'SVSFUnusedFlags',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SP_VISEME_15',
    'ISpeechPhraseReplacements', 'ISpRecognizer',
    'DISPID_SLWs_NewEnum', 'SP_VISEME_19', 'DISPID_SRCEHypothesis',
    'DISPID_SOTCDefault', 'SRSActiveAlways', 'DISPID_SPAs_NewEnum',
    'SpeechAudioProperties', 'DISPID_SPRules_NewEnum',
    'SpeechUserTraining', 'DISPID_SAFType', 'SECFIgnoreCase',
    'tagSTATSTG', 'DISPID_SpeechRecognizerStatus',
    'SpeechRecoProfileProperties', 'SSTTWildcard',
    'SpeechGrammarState', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPCLangId', 'ISpeechRecoResultTimes', 'SPWF_SRENGINE',
    'DISPID_SASCurrentSeekPosition', 'SECFNoSpecialChars',
    'DISPID_SGRsCount', 'SDTReplacement', 'SPEI_RECOGNITION',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRAttributes', 'SPVOICESTATUS',
    'ISpAudio', 'SpeechWordType', 'DISPID_SRGetPropertyString',
    'SASPause', 'ISpeechXMLRecoResult', 'DISPID_SPEs_NewEnum',
    'SPAUDIOSTATE', 'SPDKL_CurrentConfig', 'SpWaveFormatEx',
    'SpMMAudioEnum', 'SVP_16', 'SPEI_RESERVED2',
    'DISPID_SVAudioOutput', 'SPPHRASERULE',
    'DISPIDSPTSI_ActiveOffset', 'SDA_Two_Trailing_Spaces',
    'SPPS_SuppressWord', 'DISPID_SPRsItem', 'DISPIDSPRG',
    ...
    'DISPID_SABufferNotifySize', 'SPEI_MAX_TTS',
    'DISPID_SpeechPhoneConverter', 'SPRECORESULTTIMES', 'SP_VISEME_9',
    'SP_VISEME_17', 'ISpSerializeState', 'ISpeechRecoResult',
    'DISPID_SRRAlternates', 'IStream', 'SAFT16kHz8BitMono',
    'SPXMLRESULTOPTIONS', 'SREAllEvents', 'SPEI_RESERVED1',
    'SDTPronunciation', 'SASStop', 'SAFTNonStandardFormat',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SREmulateRecognition',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRCPause',
    'SPCS_DISABLED', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRSCurrentStreamPosition', 'SP_VISEME_14', 'SDTAll',
    'ISpeechPhraseProperties', 'SAFT16kHz16BitStereo', 'SVSFDefault',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechRecognizerState', 'SRAInterpreter',
    ...
    'SP_VISEME_18', 'SP_VISEME_4', 'SGDSActiveUserDelimited',
    'DISPID_SWFEChannels', 'SSFMCreateForWrite',
    'DISPID_SWFEFormatTag', 'DISPID_SRCEAudioLevel',
    'DISPID_SVEStreamEnd', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SLPsCount', 'ISpeechPhraseRule', 'SVEPhoneme',
    'DISPID_SLWLangId', 'ISpeechGrammarRuleState', 'SRAONone',
    'SAFT24kHz16BitStereo', 'SVPNormal', 'SAFTADPCM_8kHzStereo',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SpeechRecoContextEvents', 'SPGS_EXCLUSIVE',
    'SGRSTTDictation', 'eLEXTYPE_APP', 'DISPID_SpeechRecoResultTimes',
    'ISpLexicon', 'DISPID_SRCEAdaptation',
    'SpeechSpecialTransitionType', 'DISPIDSPTSI_SelectionOffset',
    'SPWORDLIST', 'SPEI_START_INPUT_STREAM', 'SRTAutopause',
    '_ISpeechRecoContextEvents', 'SECFIgnoreWidth', 'SPSInterjection',
    'DISPID_SPRulesCount', 'DISPID_SpeechBaseStream',
    'SpeechPropertyAdaptationOn', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPSModifier', 'DISPID_SPRuleParent', 'ISpRecoContext',
    'SPSHT_Unknown', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechBaseStream', 'DISPID_SRCEventInterests',
    'SPDKL_LocalMachine', 'SDKLCurrentUser', 'DISPID_SRGetFormat',
    'SpStreamFormatConverter', 'DISPID_SVSpeak',
    'SVESentenceBoundary', 'SpeechVoiceSpeakFlags',
    'SpInprocRecognizer', 'IInternetSecurityMgrSite', 'SVP_1',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SRRTTickCount',
    'SAFT48kHz16BitStereo', 'SPPS_Interjection',
    'SPEI_END_INPUT_STREAM', 'DISPID_SpeechObjectTokens',
    'ISpRecoResult', 'SVSFParseMask', 'SSTTTextBuffer', 'SGRSTTRule',
    'DISPID_SpeechDataKey', 'DISPID_SVEPhoneme',
    'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SGRInitialState', 'eLEXTYPE_RESERVED4', 'SpFileStream',
    'SPAR_Unknown', 'DISPID_SPACommit', 'DISPID_SLWType',
    'DISPID_SOTMatchesAttributes', 'eLEXTYPE_PRIVATE17',
    'SPINTERFERENCE_TOOFAST', 'SRAExport', 'ISpShortcut', 'SVPOver',
    'DISPID_SPERequiredConfidence', 'DISPID_SLGetPronunciations',
    'DISPID_SLWWord', 'SPEI_UNDEFINED', 'SpPhraseInfoBuilder',
    'eWORDTYPE_ADDED', 'DISPID_SDKGetBinaryValue', 'DISPID_SPPName',
    'DISPID_SGRsDynamic', 'DISPID_SRSetPropertyString',
    'DISPID_SPPsItem', 'SPPHRASEREPLACEMENT', 'ISpRecoCategory',
    'SPPS_RESERVED3', 'DISPID_SPIGrammarId', 'SPRST_ACTIVE_ALWAYS',
    'ISpNotifySource', 'eLEXTYPE_RESERVED9', 'SAFTADPCM_22kHzStereo',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechAudioStatus', 'SPGS_DISABLED',
    'SWTDeleted', 'eLEXTYPE_PRIVATE10', 'DISPID_SASNonBlockingIO',
    'SAFT8kHz8BitMono', 'SVEWordBoundary', 'DISPID_SRCRetainedAudio',
    'SRSEIsSpeaking', 'ISpXMLRecoResult', 'SpeechPartOfSpeech',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechMMSysAudio',
    'DISPID_SGRSAddRuleTransition', 'SAFT11kHz8BitMono',
    'SPEI_HYPOTHESIS', 'SVSFPurgeBeforeSpeak',
    'SpeechPropertyResourceUsage', 'SP_VISEME_8',
    'SPWORDPRONUNCIATIONLIST', 'SPPS_RESERVED1', 'SVSFPersistXML',
    'SPFM_OPEN_READONLY', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPRulesItem', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechTokenIdUserLexicon', 'DISPID_SVRate', 'SPEI_MIN_SR',
    'SDKLCurrentConfig', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpeechAudioFormatType',
    'SAFT24kHz8BitStereo', 'SAFTADPCM_8kHzMono', 'ISpRecognizer3',
    'DISPID_SPPFirstElement', 'SSFMOpenReadWrite', 'SREStreamEnd',
    'SPEI_SR_PRIVATE', 'DISPID_SPPEngineConfidence', 'ISpRecognizer2',
    'SRADefaultToActive', 'SPSNotOverriden', 'SRESoundStart',
    'DISPID_SVVolume', 'DISPID_SDKCreateKey', 'SAFTGSM610_22kHzMono',
    'DISPID_SRSNumberOfActiveRules', 'SVP_5', 'SAFT12kHz16BitStereo',
    'SPSFunction', 'SRSInactive', 'SPSEMANTICFORMAT', 'SGLexical',
    'SP_VISEME_11', 'SDA_No_Trailing_Space', 'eLEXTYPE_PRIVATE20',
    'SPINTERFERENCE_NOISE', 'SDTRule', 'DISPID_SPRText',
    'DISPID_SRAudioInput', 'DISPID_SADefaultFormat',
    'ISpeechObjectTokens', 'SWPKnownWordPronounceable', 'SPXRO_SML',
    'SP_VISEME_10', 'SPCT_DICTATION', 'DISPID_SPIEnginePrivateData',
    'ISpStreamFormatConverter', 'DISPID_SRCESoundEnd', 'SVF_None',
    'SVF_Emphasis', 'DISPID_SGRSTPropertyValue', 'SGRSTTTextBuffer',
    'SP_VISEME_2', 'DISPID_SRIsUISupported',
    'ISpeechObjectTokenCategory', 'SPRST_INACTIVE',
    'DISPID_SPEAudioSizeTime', 'SpeechVisemeFeature',
    'DISPID_SGRs_NewEnum', 'SECLowConfidence', 'SpeechTokenKeyUI',
    'SECNormalConfidence', 'DISPIDSPTSI_SelectionLength',
    'SpeechRunState', 'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE8',
    ...
    'SPEI_SOUND_END', 'SSFMOpenForRead', 'SPEI_TTS_BOOKMARK',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SFTInput',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVSInputWordPosition',
    'SVEPrivate', 'SPEI_PHONEME', 'DISPID_SWFEBlockAlign', 'SVP_4',
    'SpNullPhoneConverter', 'SAFT12kHz16BitMono',
    'SpeechCategoryVoices', 'SPSERIALIZEDPHRASE',
    'ISpeechGrammarRules', 'ISpeechPhraseAlternate',
    'SVEStartInputStream', 'DISPID_SpeechLexiconWord',
    'SPRST_NUM_STATES', 'SPWORDTYPE', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVESentenceBoundary',
    'DISPID_SRCState', 'eLEXTYPE_PRIVATE18',
    'DISPID_SGRSTPropertyName', 'SPRS_INACTIVE', 'WAVEFORMATEX',
    'SpeechEngineProperties', 'SAFTNoAssignedFormat',
    'eLEXTYPE_PRIVATE7', 'SPRECOSTATE', 'DISPID_SPIProperties',
    'SDA_One_Trailing_Space', 'SP_VISEME_21', 'SPFM_CREATE',
    'SRTSMLTimeout', 'eLEXTYPE_RESERVED7', 'SpeechInterference',
    'DISPID_SRGId', 'SVP_3', 'eLEXTYPE_USER_SHORTCUT',
    'SAFTGSM610_44kHzMono', 'SPINTERFERENCE', 'IEnumString',
    'ISpeechLexiconPronunciation', 'DISPID_SRRAudio',
    'DISPID_SpeechLexicon', 'SITooQuiet', 'DISPID_SVEBookmark',
    'SP_VISEME_3', 'DISPID_SRGetPropertyNumber', 'SPPARTOFSPEECH',
    'Speech_Max_Word_Length', 'SpSharedRecognizer',
    'SpeechBookmarkOptions', 'SPAR_Medium', 'SVP_7', 'SPSLMA',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPRsCount', 'SpeechFormatType',
    'ISpeechVoiceStatus', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpObjectTokenCategory', 'DISPID_SGRSTWeight',
    'DISPID_SRCRequestedUIType', 'SPWORD', 'SREStreamStart',
    ...
    'DISPID_SVWaitUntilDone', 'SPWT_DISPLAY',
    'SAFTCCITT_uLaw_11kHzMono', 'SPWT_LEXICAL', 'SPAS_STOP', 'SVP_18',
    'SpeechRecognitionType', 'SpeechTokenValueCLSID',
    'ISpRecoContext2', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVSFIsNotXML', 'DISPID_SpeechRecoContext', 'SPEVENTSOURCEINFO',
    'DISPID_SRRTimes', 'DISPID_SOTCId', 'SPEI_REQUEST_UI',
    'SpeechDataKeyLocation', 'DISPID_SFSClose', 'SVF_Stressed',
    'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SGRSRule',
    'eLEXTYPE_PRIVATE15', 'DISPID_SVSVisemeId',
    'DISPID_SPEActualConfidence', 'DISPID_SRCEEndStream',
    'SPLO_STATIC', 'DISPID_SRCResume', 'DISPID_SVIsUISupported',
    'SpShortcut', 'SVP_0', 'SGRSTTEpsilon',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_11',
    'eLEXTYPE_PRIVATE14', 'SAFTExtendedAudioFormat', 'ISpPhraseAlt',
    'SRCS_Enabled', 'DISPID_SRSSupportedLanguages', 'SVSFIsXML',
    'SPRECOGNIZERSTATUS', 'DISPID_SGRsItem',
    'DISPID_SVSLastStreamNumberQueued', 'ISpRecoGrammar',
    'SDTAlternates', 'SINone', 'ISpeechRecognizer', 'DISPID_SRCVoice',
    'SP_VISEME_16', 'DISPID_SGRSTsCount', 'SPPHRASE',
    'SPFM_CREATE_ALWAYS', 'SPEI_PHRASE_START', 'SPSMF_UPS',
    'SAFT32kHz16BitMono', 'SGLexicalNoSpecialChars',
    'DISPID_SVSLastResult', 'SRERecoOtherContext',
    ...
    'DISPID_SPEPronunciation', 'SpeechLoadOption', 'SP_VISEME_5',
    'DISPID_SGRSTType', 'DISPID_SABIEventBias',
    'DISPID_SGRSTPropertyId', 'DISPID_SRRGetXMLResult',
    'SpPhoneConverter', 'DISPID_SOTCategory', 'SPVPRIORITY',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechLexiconPronunciations', 'SINoSignal', 'SVP_12',
    'DISPID_SRRTLength', 'DISPID_SVPause', 'SpCustomStream',
    'SAFT16kHz8BitStereo', 'ISpeechPhraseAlternates', 'SLODynamic',
    'SPPS_Noun', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCCmdMaxAlternates',
    'SpInProcRecoContext', 'SpNotifyTranslator',
    'SAFT48kHz8BitStereo', 'STSF_LocalAppData', 'ISpStream',
    'SAFTGSM610_8kHzMono', 'SpPhoneticAlphabetConverter',
    'SPDKL_CurrentUser', 'DISPID_SOTCSetId', 'SRTReSent',
    'IEnumSpObjectTokens', 'DISPID_SVEAudioLevel',
    'DISPID_SRGIsPronounceable', 'SpeechCategoryRecognizers',
    'SPFM_OPEN_READWRITE', 'DISPID_SPEsCount', 'SDKLDefaultLocation',
    'DISPID_SpeechPhraseElement', 'SPSHT_OTHER',
    'DISPID_SDKEnumValues', 'DISPID_SGRsCommit', 'SP_VISEME_7',
    'SAFTADPCM_22kHzMono', 'DISPID_SPEDisplayText', 'ISpEventSource',
    'SpUnCompressedLexicon', 'SGRSTTWildcard', 'ISpeechPhraseElement',
    'SWTAdded', 'SPRS_ACTIVE', 'DISPID_SGRsCommitAndSave', 'SAFTText',
    'ISpRecoGrammar2', 'SECFIgnoreKanaType', 'DISPID_SOTsCount',
    'DISPID_SVSInputWordLength', 'SpeechEmulationCompareFlags',
    'LONG_PTR', 'DISPID_SOTCGetDataKey', 'SPINTERFERENCE_NONE',
    'DISPID_SRGReset', 'ISpeechTextSelectionInformation',
    'DISPID_SPAsItem', 'SPEVENTENUM', 'SpLexicon',
    ...
    'ISpDataKey', 'SWPUnknownWordUnpronounceable',
    'DISPID_SGRsFindRule', 'SP_VISEME_1',
    'DISPID_SpeechPhraseElements',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRIsShared',
    'SPEI_SR_BOOKMARK', 'SPEI_RESERVED5', 'SPEI_SOUND_START',
    'DISPID_SRGState', 'SPCT_SUB_DICTATION', 'SAFT8kHz16BitMono',
    'SPPS_Modifier', 'SPPS_Noncontent', 'DISPID_SASetState',
    'tagSPPROPERTYINFO', 'SpeechAudioVolume', 'DISPID_SVVoice',
    'ISpPhoneticAlphabetSelection', 'DISPID_SOTsItem',
    'SVEEndInputStream', 'SpeechStreamFileMode',
    'DISPID_SRSClsidEngine', 'SLOStatic', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVEStreamStart', 'DISPID_SPIGetText',
    'ISpeechGrammarRuleStateTransition', 'SPRECOCONTEXTSTATUS',
    'DISPID_SLPLangId', 'DISPID_SVStatus', 'SPLEXICONTYPE', 'SRARoot',
    'SITooFast', 'DISPID_SRGSetWordSequenceData', 'SECFDefault',
    'DISPID_SVEEnginePrivate', 'DISPID_SLAddPronunciation',
    'DISPID_SRGDictationLoad', 'SVP_6', 'DISPID_SPRuleId', 'UINT_PTR',
    'ISpeechLexiconWords', 'SPFM_NUM_MODES',
    'DISPID_SPANumberOfElementsInResult', 'SpMMAudioIn',
    'SAFT12kHz8BitStereo', 'SVSFIsFilename', 'DISPID_SRCERecognition',
    'eLEXTYPE_RESERVED6', 'SVEViseme', 'SVP_2', 'SLTApp',
    'SpeechTokenKeyFiles', 'DISPID_SPPChildren',
    'SpeechTokenKeyAttributes', 'STSF_FlagCreate', 'DISPID_SAFGuid',
    'SRCS_Disabled', 'DISPID_SPRuleChildren',
    'DISPID_SRCEEnginePrivate', 'DISPID_SVEViseme', 'ISpMMSysAudio',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRRecognizer',
    'DISPID_SPPValue', 'DISPID_SGRSTsItem', 'SpeechDisplayAttributes',
    'SpMMAudioOut', 'eLEXTYPE_MORPHOLOGY', 'SDTLexicalForm',
    'DISPID_SVAlertBoundary', 'SGSExclusive', 'SAFT11kHz16BitMono',
    'STCAll', 'DISPIDSPTSI_ActiveLength', 'DISPID_SRCERequestUI',
    'SVP_19', 'DISPID_SAFGetWaveFormatEx', 'DISPID_SOTId', 'SVP_9',
    'SpeechGrammarWordType', 'SpeechRecoEvents', 'SPPS_LMA',
    ...
    'DISPID_SFSOpen', 'DISPID_SOTRemove', 'DISPID_SPIRule',
    'SPEI_START_SR_STREAM', 'SPCATEGORYTYPE', 'DISPID_SLWsItem',
    'ISpeechPhraseElements', 'SVEAudioLevel',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPIReplacements',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRCEStartStream',
    'DISPID_SPIStartTime', 'SPSHORTCUTPAIR', 'SRTEmulated',
    'DISPID_SVResume', 'SREAdaptation', 'DISPID_SVSpeakStream',
    'SDKLLocalMachine', 'DISPID_SRProfile', 'SVP_14',
    'DISPID_SPRuleEngineConfidence', 'SAFT12kHz8BitMono',
    'SVSFParseAutodetect', 'SPAS_CLOSED', 'SpeechAllElements',
    'SPINTERFERENCE_TOOLOUD', 'SPRST_ACTIVE', 'DISPID_SMSSetData',
    ...
    'SPINTERFERENCE_TOOQUIET', 'SPEI_INTERFERENCE', 'SPEVENT',
    'DISPID_SVSyncronousSpeakTimeout', 'SGRSTTWord',
    'SWPUnknownWordPronounceable', 'DISPID_SDKEnumKeys',
    'SAFT44kHz8BitMono', 'SAFT44kHz16BitStereo', 'SPEI_RESERVED3',
    'ISpObjectTokenCategory', 'SAFT8kHz16BitStereo',
    'SPPHRASEPROPERTY', 'SDTAudio', 'SSSPTRelativeToCurrentPosition',
    'SVSFNLPSpeakPunc', 'DISPID_SLPSymbolic',
    'SPEI_RECO_OTHER_CONTEXT', 'SPAS_PAUSE', 'ISpVoice',
    'SpeechTokenContext', 'DISPID_SpeechPhraseReplacement',
    'SPFILEMODE', 'DISPID_SABIMinNotification',
    'DISPID_SVGetAudioInputs', 'SPVPRI_OVER', 'SVSFParseSapi',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_VOICE_CHANGE',
    'SVEVoiceChange', 'eLEXTYPE_PRIVATE16', 'SPSHORTCUTPAIRLIST',
    'SECFEmulateResult', 'SPINTERFERENCE_TOOSLOW', 'SPGRAMMARSTATE',
    'SPXRO_Alternates_SML', 'eLEXTYPE_RESERVED8', 'SPBO_NONE',
    'DISPID_SpeechAudio', 'ISpPhoneticAlphabetConverter',
    'SPEI_RESERVED6', 'DISPID_SLPPhoneIds', 'DISPID_SRGRules',
    'ISpProperties', 'DISPID_SRSetPropertyNumber', 'SPWF_INPUT',
    'DISPID_SpeechVoice', 'SRERecognition', 'SPLOADOPTIONS',
    'SPCT_SLEEP', 'SREFalseRecognition', 'ISpeechObjectToken',
    'DISPID_SVSPhonemeId', 'SPEI_TTS_PRIVATE', 'SVP_8',
    'STCInprocHandler', 'ISpeechGrammarRule', 'SVSFlagsAsync',
    'SPPS_Function', 'SVP_15', 'SREPropertyNumChange', 'DISPID_SGRId',
    'DISPID_SGRName', 'DISPID_SLPType',
    ...
    'DISPID_SRState', 'DISPID_SRGRecoContext', 'ISpResourceManager',
    'DISPID_SRGDictationSetState', 'SPPS_Verb', 'SPEI_MAX_SR',
    'SPAUDIOOPTIONS', 'ISpeechMMSysAudio', 'DISPID_SOTSetId',
    'DISPID_SPRs_NewEnum', 'DISPID_SRRTOffsetFromStart',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SOTDisplayUI', 'SPVISEMES',
    'SpeechCategoryRecoProfiles', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPPs_NewEnum', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechAudioFormat', 'SPSTREAMFORMATTYPE',
    'SpeechRuleAttributes', 'DISPID_SBSWrite', 'SDTDisplayText',
    'eWORDTYPE_DELETED', 'DISPID_SOTCreateInstance',
    'SpeechRuleState', 'SPEI_ADAPTATION', 'DISPID_SVSRunningState',
    ...
    'DISPID_SVDisplayUI', 'SBONone', 'SVP_20', 'SPSHORTCUTTYPE',
    'SpeechPropertyResponseSpeed', 'DISPID_SDKDeleteValue',
    'ISpeechAudioFormat', 'DISPID_SOTDataKey',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'eLEXTYPE_PRIVATE13',
    'SPBINARYGRAMMAR', 'SRATopLevel', 'Speech_StreamPos_RealTime',
    'DISPID_SDKSetLongValue', 'DISPID_SRCESoundStart',
    'SpeechGrammarTagDictation', 'DISPID_SMSALineId', 'ISpeechVoice',
    'SFTSREngine', 'DISPID_SRSAudioStatus', 'DISPID_SVGetProfiles',
    'SVEBookmark', 'DISPID_SPCIdToPhone', 'SPAUDIOBUFFERINFO',
    'SRSActive', 'DISPID_SAStatus', 'SPSNoun', 'SSTTDictation',
    'SP_VISEME_0', 'DISPID_SRCCreateGrammar', 'DISPID_SPAPhraseInfo',
    'ISpeechRecognizerStatus', 'STCLocalServer',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechRecoResult2',
    'IInternetSecurityManager', 'SRAORetainAudio', 'ISpStreamFormat',
    'SpeechVoicePriority', 'SVP_10', 'SGPronounciation',
    'DISPID_SpeechPhraseInfo', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechAudioStatus', 'ISpeechRecoGrammar', 'SPRULE',
    ...
    'SAFTCCITT_uLaw_22kHzStereo', 'SGDSInactive',
    'SpSharedRecoContext', 'DISPID_SpeechPhraseRules', 'SRAImport',
    ...
    'SpeechRecoContextState', 'DISPID_SVGetVoices', 'SPSVerb',
    'SPSERIALIZEDRESULT', 'SASRun', 'SDTProperty',
    'ISpGrammarBuilder', 'ISpeechDataKey', 'SVP_13', 'SITooSlow',
    'DISPID_SpeechVoiceStatus', 'SRESoundEnd',
    'DISPID_SPISaveToMemory', 'DISPID_SRRTStreamTime',
    'DISPID_SPAsCount', 'DISPID_SRStatus', 'Speech_Max_Pron_Length',
    'DISPID_SAEventHandle', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_PRIVATE6', 'SpTextSelectionInformation', 'SVP_21',
    'SPBOOKMARKOPTIONS', 'SRSEDone', 'SPINTERFERENCE_NOSIGNAL',
    'SVSFNLPMask', 'DISPID_SRRRecoContext', 'ISpeechRecoResult2',
    'SpeechDictationTopicSpelling', 'SAFT11kHz16BitStereo',
    'DISPID_SRRPhraseInfo', 'DISPID_SLPs_NewEnum',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRDisplayUI', 'SPAS_RUN',
    'SAFT22kHz8BitStereo', 'ISpeechWaveFormatEx', 'SpAudioFormat',
    'SP_VISEME_13', 'DISPID_SGRsAdd', 'DISPID_SPARecoResult',
    'SVP_17', 'DISPID_SGRAddState', 'SRTStandard',
    'SpeechGrammarTagWildcard', 'SpeechMicTraining',
    'SAFT48kHz16BitMono', 'DISPID_SGRSAddWordTransition',
    'SPPS_NotOverriden', 'DISPID_SASFreeBufferSpace', 'SASClosed',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechPhraseInfo',
    'SSSPTRelativeToStart', 'SPPROPERTYINFO', 'SPSSuppressWord',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SGDSActive',
    'DISPID_SBSSeek', 'ISpPhoneConverter', 'SpMemoryStream',
    'ISpeechAudio', 'SPAO_RETAIN_AUDIO', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechPhraseBuilder', 'SPBO_TIME_UNITS',
    'eLEXTYPE_PRIVATE19', 'DISPID_SASCurrentDevicePosition',
    'SPGRAMMARWORDTYPE', 'SPDATAKEYLOCATION', 'SPSHT_NotOverriden',
    'ISpeechMemoryStream', 'DISPID_SOTGetDescription', 'SPAO_NONE',
    'DISPID_SPIAudioSizeTime', 'DISPID_SGRSTNextState', 'SLTUser',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPIEngineId',
    'DISPID_SLPsItem', 'DISPID_SpeechAudioBufferInfo',
    'STCRemoteServer', 'DISPID_SMSAMMHandle',
    'SpeechStreamSeekPositionType', 'eLEXTYPE_PRIVATE11',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechObjectToken',
    'ISpNotifySink', 'SpeechVisemeType', 'SPPHRASEELEMENT',
    ...
    'SAFTADPCM_11kHzMono', 'STCInprocServer', 'DISPID_SGRSTRule',
    'SpeechAudioFormatGUIDWave', 'SPEI_END_SR_STREAM',
    'SpeechVoiceEvents', 'DISPID_SVSkip', 'SpCompressedLexicon',
    'SPPS_RESERVED4', 'DISPID_SVSLastBookmarkId', 'DISPID_SPPsCount',
    'eLEXTYPE_PRIVATE12', 'SpStream', 'DISPID_SOTIsUISupported',
    'SpeechLexiconType', 'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE1',
    'SREInterference', 'DISPID_SpeechFileStream', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPIElements',
    'DISPID_SLGetGenerationChange', 'eLEXTYPE_PRIVATE5',
    'SAFT8kHz8BitStereo', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPPConfidence', 'DISPID_SVEVoiceChange',
    'ISpNotifyTranslator', 'SREPrivate', 'DISPID_SLGenerationId',
    'DISPID_SRGCmdLoadFromMemory', 'SPCS_ENABLED', 'SGSDisabled',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechPhraseProperty', 'ISequentialStream', 'SRADynamic',
    'SpeechCategoryAppLexicons', 'SAFT24kHz8BitMono',
    'SpeechRegistryUserRoot', 'DISPID_SVGetAudioOutputs',
    'SPRULESTATE', 'SPAUDIOSTATUS', 'DISPID_SASState',
    ...
    'SPBO_AHEAD', 'SPEI_WORD_BOUNDARY', 'SAFT24kHz16BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVEWord', 'SBOPause',
    ...
    'SECHighConfidence', 'DISPID_SPEAudioStreamOffset', 'SVPAlert',
    'SpVoice', 'SGDisplay', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPILanguageId', 'DISPID_SRCEInterference',
    'SPWT_PRONUNCIATION', 'ISpeechPhraseRules', 'SPGS_ENABLED',
    'SPPS_Unknown', 'DISPID_SRRAudioFormat', 'SINoise',
    'SpResourceManager', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFT32kHz8BitMono', 'SAFTDefault', 'DISPID_SPEEngineConfidence',
    'DISPID_SDKDeleteKey', 'SP_VISEME_20',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKOpenKey',
    'SPAR_High', 'ISpeechLexiconWord', 'SREHypothesis',
    'DISPID_SGRSTransitions', 'DISPID_SRCreateRecoContext',
    'SPCT_COMMAND', 'DISPID_SRGCommit'
]

_check_version('1.2.0', 1697048110.496481)
